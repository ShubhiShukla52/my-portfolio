...
function PuzzleIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M19 5a2.828 2.828 0 0 1 0 4h-3v3h3a2.828 2.828 0 0 1 0 4h-3v3a2 2 0 0 1-2 2h-4v-3h3V5h-3V2h4a2 2 0 0 1 2 2v1h3Z" />
      <path d="M9 5a2.828 2.828 0 0 0 0 4h3v3H9a2.828 2.828 0 0 0 0 4h3v3a2 2 0 0 0 2 2h4v-3h-3V5h3V2h-4a2 2 0 0 0-2 2v1H9Z" />
    </svg>
  );
}
